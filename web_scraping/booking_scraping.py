...
class Booking:
    ...
    def set_date(self, start_date, end_date):
        ...
        print(f"fecha obtenida: {start_month} {start_year}")
    ...
    def get_prices(self):
        # price.text.split(" ")[1]
        return list(map(lambda price: price.text if price is not None else np.nan,
    ...
    def get_last_page(self):
        try:
            ...
            print("get_last_page error")
        

    def process_search_results(self):
        try:
            # path_url = "https://www.booking.com/index.fr.html?label=gen173nr-1BCAEoggI46AdIM1gEaE2IAQGYAQ24ARfIAQzYAQHoAQGIAgGoAgO4Arf4yJEGwAIB0gIkNmMwYWYwNGUtNGY3Ni00ZTk3LThjOGUtZWQ0OTEwMDZkZGMw2AIF4AIB;sid=4870985d274b91999c83d2a5d6f77393;keep_landing=1&sb_price_type=total&"
            ...
            print("errror process search results")
            print(err)
            # time.sleep(3)
            # self.driver.close()
    ...
    def main(self):
        try:
            ...
            print(f"main scraping {current_page} {last_page}")
            
            while current_page < last_page:
                time.sleep(3)
                
                print("se obtiene el precio")
